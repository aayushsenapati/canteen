  ...
  return (
    <div className="p-4 w-full max-w-md mx-auto">
      ...
      <select
        ...
        value={selectedShop}
        name="shop"
        className="mt-1 block w-full p-2 text-base border border-gray-300 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 rounded-md"
          ...
          <form onSubmit={handleSubmitNew} className="space-y-4">
            <label className="block">
              ...
              <input
                ...
                required
                className="mt-1 block w-full p-2 rounded border border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50"
              />
            </label>
            <label className="block">
